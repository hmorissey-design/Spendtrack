...
### **Google Assistant & Gemini Zero-Configuration Voice Actions**
- **No User Routine Setup Needed:** LooseBudget registers standard Android system intents (`android.intent.action.CREATE_NOTE`, `com.google.android.gms.actions.CREATE_NOTE`, `SEND`, and `VIEW`).
- **Commands That Work Instantly:**
  - *"Hey Google, open LooseBudget and add $15"*
  - *"Hey Google, note $14.50 at Subway in LooseBudget"*
  - *"Hey Google, open LooseBudget"*
- **Gemini Nuance:**
  - In modern Android devices with Gemini active, saying *"Post to LooseBudget"* prompts Gemini to search for an external cloud/social-media extension, triggering the *"I don't have permission to post to the app"* error.
  - Phrasing with action commands like *"Open LooseBudget and add..."* or *"Note in LooseBudget..."* directs Gemini to pass control straight to the installed local Android application.
