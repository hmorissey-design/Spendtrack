                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <div className="p-3 bg-black/40 border border-white/5 rounded-xl flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      <span className="text-base">💬</span>
                      <div>
                        <p className="text-xs font-bold text-white">SMS Bank & Card Alerts</p>
                        <p className="text-[9px] text-gray-500 font-mono">Text alerts & bank shortcodes</p>
                      </div>
                    </div>
                    <input
                      type="checkbox"
                      checked={settings.monitorSms ?? true}
